export const i18n = {
  zh: {
   ...
   // SSH Operations
    ...
    // AI Chat
    aiChat: 'AI 对话',
    aiChatFreeChat: '自由对话', aiChatAgent: 'Agent 助手', aiChatErrorAnalysis: '报错分析', aiChatGenTemplate: '生成模板', aiChatRecommend: '推荐场景', aiChatCostOpt: '成本优化',
  ...
  en: {
    ...
    // AI Chat
    aiChat: 'AI Chat',
    aiChatFreeChat: 'Free Chat', aiChatAgent: 'Agent', aiChatErrorAnalysis: 'Error Analysis', aiChatGenTemplate: 'Generate Template', aiChatRecommend: 'Recommend Scenario', aiChatCostOpt: 'Cost Optimization',
