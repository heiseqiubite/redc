...
|------|------|----------------|------|
| 预定义模板 | `aliyun/`, `aws/`, `huaweicloud/`, `tencent/`, `volcengine/`, `vultr/` | `template: "preset"` | 场景管理页面使用 |
| 自定义模板 | `base-templates/` | `template: "base"` | 自定义部署使用 |

| Userdata模板 | `userdata-templates/` | `template: "userdata"` | 自定义部署和专项场景使用 |

| Compose模板 | `compose-templates/` | `template: "compose"` | 编排管理使用 |
