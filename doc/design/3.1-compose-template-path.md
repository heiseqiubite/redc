...
| 类型 | 目录 | case.json 标记 |
|------|------|----------------|
| 预定义模板 | `aliyun`, `aws`, `huaweicloud`, `tencent`, `volcengine`, `vultr` | `template: "preset"` |
| 自定义部署模板 | `base-templates` | `template: "base"` |

| Userdata 模板 | `userdata-templates` | `template: "userdata"` |

| Compose 模板 | `compose-templates` | `template: "compose"` |
