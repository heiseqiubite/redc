...
type Case struct {
	...
	Plugins    string                 `protobuf:"bytes,13,opt,name=plugins,proto3" json:"plugins,omitempty"`
...
const file_proto_redc_proto_rawDesc = "" +
	"\n" +
	"\x10proto/redc.proto\x12\x04redc\"\xc9\x02\n" +
	"\x04Case\x12\x0e\n" +
	...
	"\aplugins\x18\r \x01(\tR\aplugins\x12\x1f\n" +
